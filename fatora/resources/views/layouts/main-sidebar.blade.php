...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">Fawater </li>
            <li class="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can(' Paid Invoices ')
                            ...
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}"> Paid Invoices</a>
                        ...
                        @can(' Unpaid Invoices ')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}">Unpaid Invoices</a>
                            </li>
                        @endcan

                        @can(' Partially Paid Invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}"> Partially Paid Invoices
                                    </a>
                            </li>
                        @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can(' Invoices Reports')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_report')) }}">Invoices Reports </a>
                            </li>
                        @endcan

                        @can(' Customers Reports')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">Customers Reports</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can(' Settings')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can(' Section')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Sections')) }}">Secttions</a></li>
                        @endcan

                        @can(' Products')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice')) }}">Products</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
