...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">Change Payment status </span>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="Plaese Enter The Invoice Number" value="{{ $invoices->invoice_number }}" required
                                    readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Ammount Collected </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">Total With Tax </label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    <option selected="true" disabled="disabled">-- Choose Paynebt Status --</option>
                                    <option value="Paid">Paid</option>
                                    <option value="partially Paied "> partially Paid</option>
