                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                <div class="card-header pb-0">
                                    @can(' Add Invoice ')
                                        <a class="modal-effect btn btn-outline-primary btn-block"  href="invoices/create"> Add Invoice</a>
                                        @endcan
                                    @can(' Excel Export ')
                                        <a class="modal-effect btn btn-outline-primary btn-block" href="{{ url('fatora/export') }}">Excel Copy</a>
                                        @endcan
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table key-buttons text-md-nowrap"
                                        data-page-length='50'style="text-align: center"> <thead>
                                                <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu tx-13">
                                                                    @can(' Invoice Modifying ')
                                                                        <a class="dropdown-item"
                                                                            href=" {{ url('edit_invoice') }}/{{ $invoice->id }}"><i
                                                                            class="text-success fas fa-pen-alt"></i>&nbsp;&nbsp;Edit
                                                                            </a>@endcan
                                                                            @can(' Delete Invoice ')
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="{{ URL::route('Status_show', [$invoice->id]) }}"><i
                                                                                class=" text-info fas fa-money-bill"></i>&nbsp;&nbsp;Change Payment Status
                                                                             </a>@endcan
                                                                             @can(' Archive Invoices')
                                                                             <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                            data-toggle="modal" data-target="#Transfer_invoice"><i
                                                                                class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; Archive Invoices
                                                                            </a>@endcan
                                                                            @can(' Print Invoice')
                                                                        <a class="dropdown-item" href="Print_invoice/{{ $invoice->id }}"><i
                                                                                class="text-primary fas fa-print"></i>&nbsp;&nbsp;Print Invoice
                ...
                <button type="submit" class="btn btn-success">Confirm</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                 Are You Sure That You What to Dowenload it?
                                <input type="hidden" name="invoice_id" id="invoice_id" value="">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
