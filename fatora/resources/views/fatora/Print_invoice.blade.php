                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">Invoice Detail </label>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tx-center">Ammount Collescted </th>
                                        <th class="tx-right">Commission </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="valign-middle" colspan="2" rowspan="4">
                                            <div class="invoice-notes">
                                                ...
                                                <textarea style="width: 100%;border: 2px solid #ccc;border-radius: 10px;
                                                " readonly placeholder={{$invoices->note}} rows="13" width=100px></textarea>
                                    ...
                                    <tr>
                                        <td class="tx-right">Tax  ({{ $invoices->Rate_VAT }})</td>
